		...
		<div class="h">
			...
			<div class="">
				...
				<div class="lc">
					...
					<p><strong>How Much Will It Cost to Self-Host My WordPress Site</strong>? <br> Luckily, not much! All you need is:</p>
					<ul>
					...
					<p>And this is where you can set:</p>
					<ul>
